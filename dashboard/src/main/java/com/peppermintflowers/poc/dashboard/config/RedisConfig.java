...
public class RedisConfig implements CachingConfigurer {
    ...
    LettuceClientConfigurationBuilderCustomizer lettuceClientConfigurationBuilderCustomizer(){
        ClusterTopologyRefreshOptions clusterTopologyRefreshOptions=
                ...
                .closeStaleConnections(true).enablePeriodicRefresh()
                .enableAdaptiveRefreshTrigger(ClusterTopologyRefreshOptions.RefreshTrigger.PERSISTENT_RECONNECTS)
                .build();

        SocketOptions socketOptions = SocketOptions.builder().keepAlive(true)
                .connectTimeout(Duration.ofMillis(Long.parseLong(connectTimeout)))
                .build();

        ClientOptions clientOptions = ClusterClientOptions.builder().socketOptions(socketOptions)
                .autoReconnect(true)
                ...
                .build();
        return builder ->
                builder.commandTimeout(Duration.ofMillis(Long.parseLong(commandTimeout)))
                        .clientOptions(clientOptions)
                        .readFrom(ReadFrom.REPLICA_PREFERRED);

    }
    @Bean
    public RedisConnectionFactory redisConnectionFactory( LettuceClientConfigurationBuilderCustomizer customizer, DefaultClientResources defaultClientResources){
        ...
        final LettuceConnectionFactory lettuceConnectionFactory = new LettuceConnectionFactory(redisClusterConfiguration, lettucePoolingClientConfiguration);
    ...
    public RedisCacheManager defaultCacheManager(RedisConnectionFactory redisConnectionFactory){
        ...
        RedisCacheManager cacheManager = RedisCacheManager.builder(redisConnectionFactory)
                ...
                .withCacheConfiguration("dashboardProductCache", config)
